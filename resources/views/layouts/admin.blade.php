...
<body class="bg-slate-50/50 flex h-screen overflow-hidden font-sans text-gray-800" 
    ...
    <aside 
        ...
        class="w-64 bg-white/95 backdrop-blur-md border-r border-gray-200/80 flex flex-col justify-between p-4 flex-shrink-0 z-30 shadow-sm"
    >
        <div>
            ...
            <div class="flex items-center justify-between text-teal-600 px-2 py-2 mb-6">
                <div class="flex items-center gap-2.5 font-bold text-xl tracking-tight">
                    <div class="w-9 h-9 rounded-xl bg-teal-600 text-white flex items-center justify-center shadow-md shadow-teal-600/30">
                ...
                <button @click="sidebarOpen = false" class="p-1.5 text-gray-400 hover:text-teal-700 hover:bg-teal-50 rounded-xl transition focus:outline-none">
    ...
    <div class="flex-1 min-w-0 flex flex-col overflow-y-auto">
        <header class="bg-white/80 backdrop-blur-md border-b border-gray-200/80 px-6 py-3.5 flex items-center justify-between sticky top-0 z-10 w-full shadow-2xs">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-2 bg-teal-50/80 text-teal-700 px-3 py-1.5 rounded-xl text-xs font-bold border border-teal-200/60">
                    <i class="bi bi-hospital text-teal-600"></i> Clínica Principal
                </div>
            </div>
        </header>

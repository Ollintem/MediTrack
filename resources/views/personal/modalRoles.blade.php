        ...
        <div x-show="openCreateModal" 
             ...
             x-data="{
                 ...
                 validarYExtraerCURP() {
                     ...
                     this.validarCoincidenciaFecha();
                 },

                 validarCoincidenciaFecha() {
                     const regexCurp = /^[A-Z]{4}\d{6}[HM][A-Z]{5}[A-Z0-9]\d$/;
                        ...
                        <div x-show="tab === 'general'" class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                <div>
                                    ...
                                    <input type="text" name="primer_nombre" value="{{ old('primer_nombre') }}" required placeholder="Ej. María" class="w-full border border-gray-300 rounded-2xl p-2.5 text-xs focus:ring-2 focus:ring-teal-500 focus:outline-none uppercase">
                                </div>
                                <div>
                                    <label class="block font-bold text-gray-700 mb-1">Apellido Paterno *</label>
                                    <input type="text" name="apellido_paterno" value="{{ old('apellido_paterno') }}" required placeholder="Ej. Cortés" class="w-full border border-gray-300 rounded-2xl p-2.5 text-xs focus:ring-2 focus:ring-teal-500 focus:outline-none uppercase">
                                </div>
                                <div>
                                    <label class="block font-bold text-gray-700 mb-1">Apellido Materno</label>
                                    <input type="text" name="apellido_materno" value="{{ old('apellido_materno') }}" placeholder="Ej. Moreno" class="w-full border border-gray-300 rounded-2xl p-2.5 text-xs focus:ring-2 focus:ring-teal-500 focus:outline-none uppercase">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="fecha_nacimiento" x-model="fechaNacimiento" @change="validarCoincidenciaFecha()" min="1900-01-01" max="{{ date('Y-m-d') }}" :class="errorCoincidenciaFecha ? 'border-rose-400 focus:ring-rose-400 bg-rose-50/20' : 'border-gray-300 focus:ring-teal-500'" class="w-full border rounded-2xl p-2.5 text-xs focus:ring-2 focus:outline-none bg-white font-medium transition-all">
